...
#  define OSSL_CMP_OPT_REVOCATION_REASON 9
#  define OSSL_CMP_OPT_IMPLICITCONFIRM 10
#  define OSSL_CMP_OPT_DISABLECONFIRM 11
#  define OSSL_CMP_OPT_UNPROTECTED_SEND 12
